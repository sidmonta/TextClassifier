...
function classify(data) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!featuresF[featureFun]) return [3 /*break*/, 1];
                    classifier.features = featuresF[featureFun];
                    return [3 /*break*/, 3];
                case 1:
                    _a = classifier;
                    return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require(featureFun)); })];
                case 2:
                    _a.features = (_b.sent()).default();
                    _b.label = 3;
